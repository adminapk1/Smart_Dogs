...
#define DATE_B 20		/*数组一维数值*/
	uint8 code sRecog[DATE_A][DATE_B] =
	{
		...
		"kai deng",         /* 开灯 */
		"guan deng",        /* 关灯 */
		"da kai dian shi",  /* 打开电视 */
		"guan bi dian shi", /* 关闭电视 */
		"da kai bing xiang",/* 打开冰箱 */
		"guan bi bing xiang",/* 关闭冰箱 */
		"da kai kong tiao", /* 打开空调 */
		"guan bi kong tiao",/* 关闭空调 */
		"quan bu da kai",   /* 全部打开 */
		"ju you shou",      /* 举右手(修正拼写) */
		"ju zuo shou",      /* 举左手(修正拼写) */
		"kai xin",          /* 开心表情 */
		"ting xia",         /* 停下 */
		"ting zhi",         /* 停止 */
		"quan bu guan bi",  /* 全部关闭 */
	};	/* 添加关键词,与 pCode 一一对应 */
	uint8 code pCode[DATE_A] =
	{
		/* 前 16 项与 sRecog 一一对应 */
		CODE_CMD, CODE_1, CODE_2, CODE_3, CODE_4,
		CODE_5, CODE_6, CODE_7, CODE_8, CODE_9,
		CODE_10, CODE_11, CODE_12, CODE_13, CODE_14,
		CODE_15,
		/* 占位区(暂无对应关键词) */
		CODE_16, CODE_17, CODE_18, CODE_19, CODE_20,
		CODE_21, CODE_22, CODE_23, CODE_24, CODE_25,
		CODE_26, CODE_27, CODE_28, CODE_29, CODE_30,
		CODE_31, CODE_32, CODE_33, CODE_34, CODE_35,
		CODE_36, CODE_37, CODE_38, CODE_39, CODE_40,
		CODE_41, CODE_42, CODE_43, CODE_44, CODE_45,
		CODE_46, CODE_47, CODE_48, CODE_49,
	};	/* 添加识别码,与 sRecog 一一对应 */
	flag = 1;
	for (k = 0; k < 16; k++)
	{
